...
public class AvroSchemaConverter {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AvroSchemaConverter.class);
     ...
     */
    public AvroSchemaConverter(final ObjectMapper mapper) {
        this.mapper = mapper;
    }
    ...
    public String convert(final String json) throws IOException {
        ...
        finalSchema.put("namespace", "com.example.practice");
